...
Linux 等平台参考 `Neovim 官方安装说明
<https://github.com/neovim/neovim/blob/master/INSTALL.md>`_。
快速版要求 Neovim 0.10+，日常版要求 0.12+。

Neovim 配置依赖
---------------

快速版不需要 Node.js、Python provider、编译器或 Tree-sitter CLI。
日常版的按需安装说明见下面“两套独立配置”。
