...
nmap <leader>fec :e ~/.config/nvim/coc-settings.json<cr>
...
" if you want pure neovim change !1 -> 1
if !1 | finish | endif
...
vim.keymap.set('', '<leader>pt', ':NvimTreeToggle<CR>', { noremap = true, silent = true })
...
vim.keymap.set('n', '<Space><Right>', '<Cmd>BufferLineCloseRight<CR>', {})
-- see, to close current buffer: https://github.com/akinsho/bufferline.nvim/issues/513
